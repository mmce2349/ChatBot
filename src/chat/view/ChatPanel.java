...
public class ChatPanel extends JPanel
{
	...
	{	
		appLayout.putConstraint(SpringLayout.WEST, searchButton, -122, SpringLayout.WEST, tweetButton);
		appLayout.putConstraint(SpringLayout.EAST, searchButton, -13, SpringLayout.WEST, tweetButton);
		appLayout.putConstraint(SpringLayout.NORTH, searchButton, 6, SpringLayout.SOUTH, chatScrollPane);
		appLayout.putConstraint(SpringLayout.SOUTH, searchButton, -18, SpringLayout.NORTH, infoLabel);
		appLayout.putConstraint(SpringLayout.NORTH, infoLabel, 256, SpringLayout.NORTH, this);
		appLayout.putConstraint(SpringLayout.WEST, infoLabel, 31, SpringLayout.WEST, this);
